...
void Dialog9::wheelEvent(QWheelEvent *event){
...
void Dialog9::on_pushButton_6_clicked()
{
    QSound::play(":/click4.wav");
    QGraphicsScene *scene =  new QGraphicsScene;
...
void Dialog9::on_pushButton_7_clicked()
{
    QSound::play(":/click4.wav");
    QGraphicsScene *scene =  new QGraphicsScene;
...
void Dialog9::on_pushButton_8_clicked()
{
    QSound::play(":/click4.wav");
    QGraphicsScene *scene =  new QGraphicsScene;
...
void Dialog9::on_pushButton_9_clicked()
{
    QSound::play(":/click4.wav");
    QGraphicsScene *scene =  new QGraphicsScene;
...
void Dialog9::on_pushButton_10_clicked()
{
    QSound::play(":/click4.wav");
    QGraphicsScene *scene =  new QGraphicsScene;
