...
Dialogr5::Dialogr5(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialogr5)
{
    ui->setupUi(this);
    ...
    QMovie *movie3 = new QMovie(":/Compton_Scattering.gif");
    ...
    QMovie *movie4 = new QMovie(":/Bremsstrahlung.gif");
...
void Dialogr5::on_pushButton_clicked()
{
