...
Dialogr11::Dialogr11(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialogr11)
{
    ui->setupUi(this);
...
void Dialogr11::on_checkBox_4_stateChanged(int arg1)
{
    if(arg1)
    {ui->checkBox_2->setChecked(false);}
}

void Dialogr11::on_checkBox_stateChanged(int arg1)
{
    if(arg1)
    {ui->checkBox_3->setChecked(false);}
}

void Dialogr11::on_checkBox_3_stateChanged(int arg1)
{
    if(arg1)
    {ui->checkBox->setChecked(false);}
}

void Dialogr11::on_checkBox_2_stateChanged(int arg1)
{
    if(arg1)
    {ui->checkBox_4->setChecked(false);}
}

void Dialogr11::on_pushButton_clicked()
{
...
void Dialogr11::on_pushButton_2_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialogr11::on_pushButton_3_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialogr11::on_pushButton_4_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialogr11::on_pushButton_5_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialogr11::on_pushButton_6_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialogr11::on_pushButton_7_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
