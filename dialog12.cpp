...
void Dialog12::on_checkBox_3_stateChanged(int arg1)
{
    if(arg1)
...
void Dialog12::on_checkBox_4_stateChanged(int arg1)
{
    if(arg1)
...
void Dialog12::on_checkBox_stateChanged(int arg1)
{
    if(arg1)
...
void Dialog12::on_checkBox_2_stateChanged(int arg1)
{
    if(arg1)
...
void Dialog12::on_checkBox_5_stateChanged(int arg1)
{
    if(arg1)
    {ui->checkBox->setChecked(false);
     ui->checkBox_3->setChecked(false);}
...
void Dialog12::on_checkBox_6_stateChanged(int arg1)
{
    if(arg1)
    {ui->checkBox_4->setChecked(false);
     ui->checkBox_2->setChecked(false);}
...
void Dialog12::on_pushButton_5_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialog12::on_pushButton_6_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
...
void Dialog12::on_pushButton_7_clicked()
{
    if(ui->checkBox->isChecked())
    {
        QSound::play(":/click4.wav");
